...
function TableData({
    ...
    const handleSort = () => {
        if (sort === 'asc') {
            ...
            switch (name) {
                case process.env.REACT_APP_MANAGER_FUND_AGRICULTURE_HEADER:
                case process.env.REACT_APP_MANAGER_FUND_USD_HEADER:
                    sortASC('cycle');
                    break;
                case process.env.REACT_APP_DEPOSITS_HISTORY:
                case process.env.REACT_APP_WITHDRAWS_HISTORY:
                    sortASC('createdAt');
                    break;
                default:
                    sortASC('_id');
