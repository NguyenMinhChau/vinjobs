...
export const handleDepositsSV = async (props = {}) => {
  ...
  const resPut = await adminPut(`handleDeposit/${id_deposits}`, {
    token: token,
    status: statusUpdate || statusCurrent,
    header: {
      token: token,
...
export const deleteFundUSDsSV = async (props = {}) => {
  const { id_fund, token, setSnackbar, dispatch, setIsProcess, state } = props;
...
export const handleFundUsdSV = async (props = {}) => {
  ...
  const resPut = await adminPut(`handleContract/${id_fund}`, {
    token: token,
    status: statusUpdate || statusCurrent,
    header: {
      token: token,
...
export const updateRuleUserSV = async (props = {}) => {
  ...
  const resPut = await adminPut(`/rule/change/${id_user}`, {
    token: token,
...
export const deleteUserSV = async (props = {}) => {
  const { id_user, dispatch, state, setSnackbar, token, setIsProcess } = props;
...
export const blockUserByEmailSV = async (props = {}) => {
  ...
  const resPut = await adminPut(`/user/block/${email_user}`, {
    token: token,
    headers: {
      token: token,
    },
...
export const refreshPwdUserSV = async (props = {}) => {
  ...
  const resPost = await adminPut(`/password/refresh/${id_user}`, {
    token: token,
    headers: {
      token: token,
    },
...
export const changePwdUserSV = async (props = {}) => {
  ...
  const resPost = await adminPut(`/password/change/${id_user}`, {
    password: password,
    token: token,
    headers: {
      token: token,
